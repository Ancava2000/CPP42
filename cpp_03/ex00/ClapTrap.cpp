...
/*   Updated: 2025/11/04 11:55:43 by acarro-v         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::takeDamage(unsigned int amount){
	if(_hit_points < 1){
		...
		_hit_points -= amount;
		std::cout << amount << " points of damage taken, Claptrap " << _name << " is destroyed" << std::endl;
	}
	else{
		_hit_points -= amount;
		std::cout << amount << " points of damage taken" << std::endl;
	}
}
...
void ClapTrap::beRepaired(unsigned int amount){
	if(_hit_points < 1){
		...
		_hit_points = 10;
		_energy_points--;
		std::cout << "Claptrap " << _name << " restored all hit points" << std::endl;
	}
}